...
with st.sidebar:
    ...
    new_climber_dict["experience"] = st.number_input("Number of years climbing",value=4)
    ...
    new_climber_dict["finger strength"] = 1 + (st.number_input("Max additional weight for a 10s hang on a 20mm edge (lbs)", value=60) / new_climber_dict["weight"])
